from checkmate_tool.book_data import BookData, Format
from checkmate_tool.book_site.common.utils import query_html, get_soup_from_url
from checkmate_tool.book_site import base_parser
import requests, bs4
